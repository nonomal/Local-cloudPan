  ...
  },
  {
    ...
    response: () => ({
      ...
      data: {
        ...Mock.mock({
          fileList: [
            { name: '1.txt', type: 'file', ext: 'txt' },
            { name: 'upload', type: 'directory', ext: '' },
            { name: '黄昏.mp4', type: 'file', ext: 'mp4' },
            { name: '笔记.md', type: 'file', ext: 'md' },
            { name: '数据集.zip', type: 'file', ext: 'zip' },
            { name: '证件照.png', type: 'file', ext: 'png' },
          ],
        }),
      },
    }),
